...
BEGIN
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'whatsmeow_device_old') THEN
        ...
        SELECT
            jid, lid, facebook_uuid, registration_id,
            pgp_sym_encrypt(noise_key, 'pergo_whatsmeow_secret'),
            pgp_sym_encrypt(identity_key, 'pergo_whatsmeow_secret'),
            pgp_sym_encrypt(signed_pre_key, 'pergo_whatsmeow_secret'),
            signed_pre_key_id,
            pgp_sym_encrypt(signed_pre_key_sig, 'pergo_whatsmeow_secret'),
            pgp_sym_encrypt(adv_key, 'pergo_whatsmeow_secret'),
            pgp_sym_encrypt(adv_details, 'pergo_whatsmeow_secret'),
            pgp_sym_encrypt(adv_account_sig, 'pergo_whatsmeow_secret'),
            pgp_sym_encrypt(adv_account_sig_key, 'pergo_whatsmeow_secret'),
            pgp_sym_encrypt(adv_device_sig, 'pergo_whatsmeow_secret'),
            platform, business_name, push_name, lid_migration_ts
...
SELECT 
    ...
    facebook_uuid,
    registration_id,
    pgp_sym_decrypt(noise_key, 'pergo_whatsmeow_secret') AS noise_key,
    pgp_sym_decrypt(identity_key, 'pergo_whatsmeow_secret') AS identity_key,
    pgp_sym_decrypt(signed_pre_key, 'pergo_whatsmeow_secret') AS signed_pre_key,
    signed_pre_key_id,
    pgp_sym_decrypt(signed_pre_key_sig, 'pergo_whatsmeow_secret') AS signed_pre_key_sig,
    pgp_sym_decrypt(adv_key, 'pergo_whatsmeow_secret') AS adv_key,
    pgp_sym_decrypt(adv_details, 'pergo_whatsmeow_secret') AS adv_details,
    pgp_sym_decrypt(adv_account_sig, 'pergo_whatsmeow_secret') AS adv_account_sig,
    pgp_sym_decrypt(adv_account_sig_key, 'pergo_whatsmeow_secret') AS adv_account_sig_key,
    pgp_sym_decrypt(adv_device_sig, 'pergo_whatsmeow_secret') AS adv_device_sig,
    platform,
    business_name,
    push_name,
    lid_migration_ts
...
BEGIN
    ...
    VALUES (
        ...
        pgp_sym_encrypt(NEW.noise_key, 'pergo_whatsmeow_secret'),
        pgp_sym_encrypt(NEW.identity_key, 'pergo_whatsmeow_secret'),
        pgp_sym_encrypt(NEW.signed_pre_key, 'pergo_whatsmeow_secret'),
        NEW.signed_pre_key_id,
        pgp_sym_encrypt(NEW.signed_pre_key_sig, 'pergo_whatsmeow_secret'),
        pgp_sym_encrypt(NEW.adv_key, 'pergo_whatsmeow_secret'),
        pgp_sym_encrypt(NEW.adv_details, 'pergo_whatsmeow_secret'),
        pgp_sym_encrypt(NEW.adv_account_sig, 'pergo_whatsmeow_secret'),
        pgp_sym_encrypt(NEW.adv_account_sig_key, 'pergo_whatsmeow_secret'),
        pgp_sym_encrypt(NEW.adv_device_sig, 'pergo_whatsmeow_secret'),
...
SELECT
    jid, lid, facebook_uuid, registration_id,
    pgp_sym_decrypt(noise_key, 'pergo_whatsmeow_secret'),
    pgp_sym_decrypt(identity_key, 'pergo_whatsmeow_secret'),
    pgp_sym_decrypt(signed_pre_key, 'pergo_whatsmeow_secret'),
    signed_pre_key_id,
    pgp_sym_decrypt(signed_pre_key_sig, 'pergo_whatsmeow_secret'),
    pgp_sym_decrypt(adv_key, 'pergo_whatsmeow_secret'),
    pgp_sym_decrypt(adv_details, 'pergo_whatsmeow_secret'),
    pgp_sym_decrypt(adv_account_sig, 'pergo_whatsmeow_secret'),
    pgp_sym_decrypt(adv_account_sig_key, 'pergo_whatsmeow_secret'),
    pgp_sym_decrypt(adv_device_sig, 'pergo_whatsmeow_secret'),
    platform, business_name, push_name, lid_migration_ts
FROM whatsmeow_device_raw;
