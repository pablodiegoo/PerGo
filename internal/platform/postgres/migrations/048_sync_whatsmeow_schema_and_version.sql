...
-- Ensure all whatsmeow relational tables are present and whatsmeow_version is set to 14.
-- This ensures whatsmeow's internal upgrade check is satisfied without erroring on existing tables.
