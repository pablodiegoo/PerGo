# Graph Report - PerGo  (2026-07-03)

## Corpus Check
- 1321 files · ~1,876,689 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8627 nodes · 9192 edges · 1200 communities (1052 shown, 148 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 699 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c895400`
...
1. `Communities (1127 total, 134 thin omitted)` - 544 edges
2. `New()` - 151 edges
3. `main()` - 57 edges
4. `Render()` - 37 edges
5. `NewWorkspaceRepository()` - 35 edges
6. `WorkspaceRepository` - 26 edges
7. `NewSQLDB()` - 25 edges
8. `Workspace` - 25 edges
9. `getTestPool()` - 24 edges
10. `setupWorkspaceRoutes()` - 22 edges

## Surprising Connections (you probably didn't know these)
- `TestConnectionsSpike()` --calls--> `NewEncryptor()`  [INFERRED]
  .agents/skills/spike-findings-pergo/sources/001-multi-instance-schema/connections_spike_test.go → internal/platform/crypto/encrypt.go
- `TestConnectionsSpike()` --calls--> `New()`  [INFERRED]
  .agents/skills/spike-findings-pergo/sources/001-multi-instance-schema/connections_spike_test.go → internal/platform/echo/echo.go
- `TestConnectionsSpike()` --calls--> `NewSQLDB()`  [INFERRED]
  .agents/skills/spike-findings-pergo/sources/001-multi-instance-schema/connections_spike_test.go → internal/platform/postgres/pool.go
- `TestConnectionsSpike()` --calls--> `NewWorkspaceRepository()`  [INFERRED]
  .agents/skills/spike-findings-pergo/sources/001-multi-instance-schema/connections_spike_test.go → internal/repository/workspace.go
- `ResolveRoute()` --calls--> `New()`  [INFERRED]
  .agents/skills/spike-findings-pergo/sources/002-api-routing-payload/routing_spike_test.go → internal/platform/echo/echo.go

## Import Cycles
- None detected.

## Communities (1200 total, 148 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (38): Echo, T, setupTestRoutes(), TestAdminDashboardAuthenticated(), TestAdminDashboardContent(), TestAdminHTMXFragment(), TestAdminLoginPage(), TestAdminLoginSuccess() (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.00
Nodes (544): Communities (1127 total, 134 thin omitted), Community 0 - "Community 0", Community 100 - "Community 100", Community 101 - "Community 101", Community 102 - "Community 102", Community 103 - "Community 103", Community 104 - "Community 104", Community 105 - "Community 105" (+536 more)
...
Cohesion: 0.16
Nodes (11): T, TestWhatsAppInbound(), calcBackoff(), Context, DB, Duration, JID, Mutex (+3 more)

### Community 4 - "Community 4"
Cohesion: 0.27
Nodes (10): CreateMessageRequest, CreateMessageResponse, ErrorResponse, FieldError, Media, MessageStatus, TemplateComponent, TemplateParameter (+2 more)
...
Cohesion: 0.33
Nodes (7): Context, Pool, Time, UUID, NewMessageDispatchRepository(), MessageDispatch, MessageDispatchRepository

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (38): 0. Git Branch Invariant, 10. Spawn gsd-plan-checker Agent, 11. Handle Checker Return, 11a. Filesystem Fallback (Checker), 12.5. Plan Bounce (Optional External Refinement), 12. Revision Loop (Max 3 Iterations), 13. Requirements Coverage Gate, 13a. Decision Coverage Gate (+30 more)

### Community 12 - "Community 12"
Cohesion: 0.16
Nodes (14): CredentialProvider, mockConnectionRepo, mockPublisher, Context, UUID, Context, Pool, Row (+6 more)
...
Cohesion: 0.05
Nodes (37): Check 8a — Automated Verify Presence, Check 8b — Feedback Latency Assessment, Check 8c — Sampling Continuity, Check 8d — Wave 0 Completeness, Check 8e — VALIDATION.md Existence (Gate), Dimension 10: GEMINI.md Compliance, Dimension 11: Research Resolution (#1602), Dimension 12: Pattern Compliance (#1861) (+29 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (42): ConsumerConfig, Encryptor, NewEncryptor(), createConsumerWithRetry(), EnsureConsumer(), EnsureStream(), EnsureWebhookStream(), Conn (+34 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (37): Check 8a — Automated Verify Presence, Check 8b — Feedback Latency Assessment, Check 8c — Sampling Continuity, Check 8d — Wave 0 Completeness, Check 8e — VALIDATION.md Existence (Gate), Dimension 10: AGENTS.md Compliance, Dimension 11: Research Resolution (#1602), Dimension 12: Pattern Compliance (#1861) (+29 more)
...
Cohesion: 0.22
Nodes (7): BatchWriter, Event, Pool, WaitGroup, Time, UUID, NewEvent()

### Community 26 - "Community 26"
Cohesion: 0.16
Nodes (10): DashboardHandler, Querier, RecentEntry, Context, Pool, Context, Pool, Time (+2 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (27): T, testDSN(), TestGracefulShutdown(), TestServerBootHealthz(), TestServerBootReadyz(), TestServerBootReadyzDown(), Context, DB (+19 more)
...
Cohesion: 0.14
Nodes (11): ConfigureProxy(), Context, DB, JID, Logger, NewWhatsAppClient(), T, TestConfigureProxy() (+3 more)
...
Cohesion: 0.23
Nodes (13): deviceColumns(), Context, Pool, Row, Rows, Time, UUID, NewDeviceRepository() (+5 more)
...
Cohesion: 0.26
Nodes (24): T, TestMessageHandler_CreateWithMedia(), defaultMockConnectionRepo(), T, newTestMessageHandler(), testContext(), TestCreateMessageChannelMismatch(), TestCreateMessageInvalidChannel() (+16 more)
...
Cohesion: 0.15
Nodes (15): DeviceHandler, pairingState, Context, Manager, RWMutex, Time, Component, Render() (+7 more)

### Community 44 - "Community 44"
Cohesion: 0.11
Nodes (20): T, TestAuditDropCounter(), TestExpvarHandler(), TestOrchestratorIdempotent(), TestOrchestratorOrder(), TestOrchestratorSlowCleanup(), TestOrchestratorTimeout(), TestPprofServer() (+12 more)
...
Cohesion: 0.20
Nodes (15): Context, Pool, Time, UUID, WebhookConfig, WebhookDLQ, WebhookDLQRepository, DLQBadgeFragment() (+7 more)

### Community 47 - "Community 47"
Cohesion: 0.20
Nodes (5): Int64, JID, RWMutex, ActiveSession, Session

### Community 48 - "Community 48"
Cohesion: 0.16
Nodes (15): PlaygroundHandler, Conn, Context, NewPlaygroundHandler(), JetStream, ParsedTemplateDetails, JetStreamPublisher, Component (+7 more)
...
Cohesion: 0.13
Nodes (26): Pool, T, mustPool(), TestAuthMiddlewareCacheHit(), TestAuthMiddlewareInvalid(), TestAuthMiddlewareMissing(), TestAuthMiddlewareRevoked(), TestAuthMiddlewareValid() (+18 more)
...
Cohesion: 0.16
Nodes (16): NATSStatus, SessionInfo, TelemetryData, TelemetryHandler, formatDuration(), Context, Duration, Manager (+8 more)

### Community 65 - "Community 65"
Cohesion: 0.21
Nodes (12): WABATemplateHandler, Context, CredentialsRepository, NewWABATemplateHandler(), IsHTMX(), htmxKey, Component, UUID (+4 more)
...
Cohesion: 0.10
Nodes (20): Ambiente de Desenvolvimento (Local), Ambiente de Produção, Ambiente Docker / Docker Compose, Armazenamento S3 (Mídias e Anexos), Configuração do Sistema (Environment Variables), Configurações Obrigatórias, Configurações Obrigatórias vs Opcionais, Configurações Opcionais (+12 more)
...
Cohesion: 0.16
Nodes (14): retryAttempt(), Duration, T, UUID, intPtr(), newTestOrchestrator(), TestDeliveryDedup(), TestExponentialBackoff() (+6 more)
...
Cohesion: 0.21
Nodes (9): adaptMsg(), CancelFunc, Consumer, Context, Duration, Msg, NewWorker(), jetStreamMsg (+1 more)

### Community 80 - "Community 80"
Cohesion: 0.20
Nodes (13): NewTerminalError(), Context, MetaErrorResponse, WABAAdapter, wabaComponent, WABAConfig, wabaLanguage, wabaMessageRequest (+5 more)
...
Cohesion: 0.23
Nodes (10): Context, Pool, Time, UUID, NewWABATemplateRepository(), T, TestWABATemplateRepository(), RawMessage (+2 more)

### Community 90 - "Community 90"
Cohesion: 0.16
Nodes (13): inboundPayload, InboxHandler, Context, InboxMessage, Base(), Component, LoginBase(), Component (+5 more)
...
Cohesion: 0.11
Nodes (17): 1. Probes de Saúde (Health & Readiness), 1. URL Externa Segura (HTTPS), 2. Chave Mestra de Criptografia (KEK), 2. Logs Estruturados, 3. Métricas e Profiling Interno, 3. Senha Administrativa Forte, 4. Isolamento da Porta de Debug, Ambientes de Implantação (Deployment Targets) (+9 more)
...
Cohesion: 0.29
Nodes (3): WebhookDLQHandler, Context, NewWebhookDLQHandler()
...
Cohesion: 0.13
Nodes (17): InboundContact, InboundEventPayload, InboundLocation, InboundMedia, ValueData, ValueStruct, wabaMediaObj, wabaVerifyCreds (+9 more)

### Community 99 - "Community 99"
Cohesion: 0.11
Nodes (20): LoadOptions, Context, getTestPool(), Pool, T, TestTelegramDispatch(), T, TestWhatsAppAdapter_Media() (+12 more)
...
Cohesion: 0.12
Nodes (16): CredentialProvider, CredentialProvider Port (ADR-0004), DispatchOrchestrator (ADR-0001), DispatchOrchestrator tests, Further Notes, Implementation Decisions, InboundProcessor (ADR-0002), InboundProcessor tests (+8 more)

### Community 104 - "Community 104"
Cohesion: 0.26
Nodes (9): QueueMessage, Context, Duration, Map, UUID, NewDispatchOrchestrator(), DispatchMessage, DispatchOrchestrator (+1 more)

### Community 105 - "Community 105"
Cohesion: 0.21
Nodes (13): Context, Logger, isTerminalWhatsAppError(), NewWhatsAppAdapter(), phoneToJID(), T, TestIsTerminalWhatsAppError(), TestIsTerminalWhatsAppErrorNil() (+5 more)

### Community 106 - "Community 106"
Cohesion: 0.29
Nodes (16): T, TestErrorResponseJSON(), TestMessageStatusValues(), TestValidateMessageEmptyBodyAndMedia(), TestValidateMessageInvalidChannel(), TestValidateMessageMedia(), TestValidateMessageMissingChannel(), TestValidateMessageMissingTo() (+8 more)

### Community 107 - "Community 107"
Cohesion: 0.32
Nodes (20): getAuditSessionCookie(), Cookie, Echo, Pool, T, Time, UUID, seedAuditEvent() (+12 more)
...
Cohesion: 0.16
Nodes (20): Map, MiddlewareFunc, UUID, NewQueueDepthTracker(), NewRateLimiter(), RateLimiterMiddleware(), T, TestQueueDepthTrackerDecrementFloor() (+12 more)
...
Cohesion: 0.12
Nodes (16): Architecture & Strategy Notes, Canonical References, Database & Migration, Deferred Ideas, Established Patterns, Existing Code Insights, Folded Todos, Implementation Decisions (+8 more)
...
Cohesion: 0.12
Nodes (15): Critical constraint, How to Run, HTMX polling pattern, Investigation Trail, New message highlight, Observability, Polling validation, Polling vs SSE (+7 more)

### Community 118 - "Community 118"
Cohesion: 0.20
Nodes (11): Client, GetObjectInput, GetObjectOutput, Options, PutObjectInput, PutObjectOutput, Config, Context (+3 more)

### Community 119 - "Community 119"
Cohesion: 0.31
Nodes (12): mockDispatcher, NewRegistry(), Context, T, TestMockDispatcherTerminalError(), TestNewRegistryCopiesMap(), TestRegistryConcurrentAccess(), TestRegistryGet() (+4 more)

### Community 120 - "Community 120"
Cohesion: 0.27
Nodes (7): Context, UUID, NewWindowChecker(), T, TestWindowChecker_IsWindowOpen(), RecipientSessionReader, WindowChecker

### Community 121 - "Community 121"
Cohesion: 0.12
Nodes (15): 1. Testes Unitários, 2. Testes de Concorrência, 3. Testes de Integração, Boas Práticas:, CI Integration, Como Escrever Testes, Coverage Requirements, Executando Linter e Validação Estática (+7 more)
...
Cohesion: 0.20
Nodes (11): HashAPIKey(), hmacEqual(), VerifyAPIKey(), Context, Pool, RWMutex, Time, UUID (+3 more)

### Community 131 - "Community 131"
Cohesion: 0.16
Nodes (17): TestTenantContext(), Context, NewWABAAdapter(), getTestPool(), Context, Pool, T, UUID (+9 more)
...
Cohesion: 0.13
Nodes (14): Bubble corner radius, Bubble design, Gap discovered: outbound audit events, How to Run, Investigation Trail, Layout: CSS Grid vs Flexbox, Message thread query, Research (+6 more)

### Community 134 - "Community 134"
Cohesion: 0.19
Nodes (12): Writer, Context, UUID, hashBytes(), NewInboundProcessor(), Message, DownloadFunc, InboundContact (+4 more)
...
Cohesion: 0.14
Nodes (13): 1. Conversation List Query, 2. Message Thread Query, 3. HTMX Route Handlers, 4. Template Structure (templ), 5. HTMX Wiring in Templates, 6. Sidebar Link, 7. Toast for Background Conversations, Constraints (+5 more)

### Community 146 - "Community 146"
Cohesion: 0.25
Nodes (9): MockActiveSessionRegistry, MockMessagePayload, MockTelegramAdapter, MockWhatsAppWebAdapter, MockWhatsMeowClient, Context, T, UUID (+1 more)

### Community 147 - "Community 147"
Cohesion: 0.14
Nodes (13): 1. Modificar Páginas de UI (`.templ`), 2. Rodar Testes Unitários, 3. Análise Estática (Linter), Branch Conventions, Build Commands, Code Style (golangci-lint, go fmt), Estrutura de Diretórios, Fluxo de Trabalho de Desenvolvimento (+5 more)
...
Cohesion: 0.14
Nodes (13): 1. Database Schema Consolidation & Migration (D-01), 1. Ingest Payload (`POST /api/v1/messages`), 1. Stateless Channels (WABA / Telegram), 2. API Changes & Ingest Dynamic Routing, 2. Route Resolution on Ingestion, 2. Stateful Channels (whatsmeow WhatsApp Web), 3. Static Adapters & Concurrency Model, 4. SOCKS5/HTTP Proxy Support for whatsmeow (+5 more)

### Community 159 - "Community 159"
Cohesion: 0.25
Nodes (10): Context, Pool, Time, UUID, NewRecipientSessionRepository(), Context, UUID, RecipientSession (+2 more)
...
Cohesion: 0.15
Nodes (12): Architecture Section, Conventions Section, Fallback Behavior, GEMINI.md Template, Marker Format, Profile Section (Placeholder Only), Project Section, Section Ordering (+4 more)
...
Cohesion: 0.13
Nodes (14): Overview, Phase 07.1: Close gap: v1.0 audit gaps (INSERTED), Phase 1: Foundation, Phase 2: Admin Shell, Phase 3: Ingest API & Queue, Phase 4: WhatsApp Web & QR Pairing, Phase 5: Official Channels & Smart Fallback, Phase 6: Webhook Delivery & DLQ (+6 more)
...
Cohesion: 0.16
Nodes (22): AuditHandler, Context, parseAuditFilters(), buildWhereClause(), Context, Pool, Time, UUID (+14 more)
...
Cohesion: 0.09
Nodes (21): 1. Run Dependencies (Postgres & NATS), 1. Send a Text Message (WhatsApp Web), 2. Environment Variables, 2. Send a Text Message with Fallbacks (Telegram with WABA fallback), 3. Running Locally, 3. Send a Media Message, 4. Running via Docker, 4. Send a WhatsApp Template (WhatsApp Cloud API) (+13 more)
...
Cohesion: 0.17
Nodes (11): 1. Database Schema (`connections`), 2. API Validation and Ingestion Routing, 3. Static Adapters with Dynamic Instance Routing, Constraints, How to Build It, Multi-Instance Routing & Consolidation, Origin, Requirements (+3 more)

### Community 210 - "Community 210"
Cohesion: 0.17
Nodes (11): 1. WhatsApp Web (whatsmeow), 2. Telegram Bot, 3. WhatsApp Cloud API (WABA), Configuração:, Configuração de Canais e Provedores (Webhooks e Credenciais), Passo 1: Criar aplicativo na Meta, Passo 1: Criar o Bot no Telegram, Passo 2: Configurar no PerGo (+3 more)
...
Cohesion: 0.17
Nodes (10): MessagePayload, TerminalError, UUID, IsTerminal(), T, TestIsTerminalNil(), TestIsTerminalNonTerminal(), TestTerminalError() (+2 more)

### Community 220 - "Community 220"
Cohesion: 0.33
Nodes (10): telegramAudio, telegramChat, telegramConfig, telegramContact, telegramDocument, telegramLocation, telegramMessage, telegramPhoto (+2 more)

### Community 221 - "Community 221"
Cohesion: 0.16
Nodes (18): WorkspaceHandler, Context, CredentialsRepository, UUID, TelegramConfig, WABAConfig, Component, maskToken() (+10 more)

### Community 222 - "Community 222"
Cohesion: 0.23
Nodes (10): Context, Pool, Time, UUID, Workspace, WorkspaceRepository, Dashboard(), Component (+2 more)
...
Cohesion: 0.18
Nodes (10): Auto-Group by Design Area, Copy Source Files, Curate Sketches One-at-a-Time, Determine Output Skill Name, Gather Sketch Inventory, ▶ Next Up, Synthesize Reference Files, Update Project GEMINI.md (+2 more)
...
Cohesion: 0.18
Nodes (10): Current Architecture, Gotchas & Decisions, How to Run, Investigation Trail, Proposed Consolidated Schema: `connections`, Research, Results, Spike 001: Multi-Instance Schema Redesign (+2 more)

### Community 243 - "Community 243"
Cohesion: 0.18
Nodes (10): Channel filter tabs vs dropdown, How to Run, Investigation Trail, Key Finding: Contact name resolution, Research, Results, Spike 004: Inbox Conversation List, The Conversation Data Model (+2 more)

### Community 244 - "Community 244"
Cohesion: 0.29
Nodes (9): getTestPool(), Pool, T, TestInboundAuditLogging(), TestTelegramWebhookHandler(), connectNATS(), Conn, T (+1 more)
...
Cohesion: 0.14
Nodes (12): MediaHandler, Context, NewMediaHandler(), NewTelegramAdapter(), Context, ReadCloser, Request, S3Client (+4 more)

### Community 256 - "Community 256"
Cohesion: 0.14
Nodes (28): Pool, T, mustAuditPool(), TestAuditEventWritten(), TestAuditLogSchema(), TestAuditNoDedup(), TestBatchWriterDrainOnClose(), TestBatchWriterFlushAt100() (+20 more)
...
Cohesion: 0.18
Nodes (10): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - OmniGo  (2026-06-28), Import Cycles, Knowledge Gaps, Suggested Questions (+2 more)
...
Cohesion: 0.18
Nodes (10): Accomplishments, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance, Phase 8 Wave 1: Multi-Instance Connections Database Schema Consolidation (+2 more)
...
Cohesion: 0.20
Nodes (9): Dynamic Resolution on Worker, How to Run, Investigation Trail, Request Payload Evolution, Research, Results, Spike 002: API Payload Routing and Fallback, What This Validates (+1 more)

### Community 286 - "Community 286"
Cohesion: 0.20
Nodes (9): Approach A: Dynamic Dispatcher Pool, Approach B: Static Adapters with Dynamic Instance Routing (Recommended / Winner), How to Run, Investigation Trail, Research, Results, Spike 003: Dynamic Adapter Registry and Lifecycle, What This Validates (+1 more)

### Community 287 - "Community 287"
Cohesion: 0.20
Nodes (9): ADR-0001: Deepen Worker into DispatchOrchestrator, Consequences, Constructor (6 params, down from 8), Context, Decision, Deserialization, DispatchMessage port, Fallback behavior (+1 more)

### Community 288 - "Community 288"
Cohesion: 0.20
Nodes (9): 1. Ingestion (`POST /api/v1/messages`), 2. Queue & De-queue, 3. Execution, Fallback, & Webhooks, Component Diagram, Data Flow, Directory Structure Rationale, Key Abstractions, PerGo Architecture Overview (+1 more)

### Community 289 - "Community 289"
Cohesion: 0.20
Nodes (9): 1. Clonar e Acessar o Repositório, 2. Configurar Variáveis de Ambiente, 3. Subir Infraestrutura Local, 4. Compilar e Executar em Desenvolvimento, 5. Primeiro Acesso e Configuração, Como Começar (Getting Started), Problemas Comuns de Configuração (Common Setup Issues), Pré-requisitos (+1 more)
...
Cohesion: 0.44
Nodes (9): NewActiveSession(), T, TestActiveSessionAddGet(), TestActiveSessionAll(), TestActiveSessionConcurrentAccess(), TestActiveSessionRemove(), TestActiveSessionReplace(), TestActiveSessionStopAll() (+1 more)
...
Cohesion: 0.22
Nodes (8): 1. Left Navigation Sidebar, 2. Onboarding Step Card, Admin Dashboard UI & UX, CSS Patterns, Design Decisions, HTML Structures, Origin, What to Avoid

### Community 327 - "Community 327"
Cohesion: 0.22
Nodes (8): ADR-0002: Extract InboundProcessor from Session Manager, Boundaries, Consequences, Constructor (5 params), Context, Decision, Interface, Test strategy

### Community 328 - "Community 328"
Cohesion: 0.22
Nodes (8): Adapters, ADR-0004: Extract CredentialProvider port from crypto.Encryptor, Changed files, Consequences, Consumers, Context, Decision, Port (in `internal/repository/`)
...
Cohesion: 0.31
Nodes (3): Dispatcher, Registry, RWMutex
...
Cohesion: 0.22
Nodes (8): Goals, Quick Task GS5: criar-tela-configuracao-credenciais-canais - Plan, Task 1: Update workspace handler dependencies, Task 2: Implement save/delete credentials handlers, Task 3: Load credentials in WorkspaceHandler.Detail, Task 4: Design templates for Channel Credentials Configuration, Task 5: Verification, Tasks

### Community 351 - "Community 351"
Cohesion: 0.22
Nodes (8): Admin UI, Admin UI (HTMX), Backend, Backend, Patterns, Spike Conventions, Stack, Structure
...
Cohesion: 0.25
Nodes (7): 1. Enviar Mensagem, 2. Webhooks de Notificação (Inbound), Autenticação, Envio de Mídia (Imagens, Documentos e Áudios), Envio de Templates (Exclusivo WhatsApp Cloud), Payload Padrão (Mensagem de Texto), Referência da API (API Reference)

### Community 370 - "Community 370"
Cohesion: 0.39
Nodes (5): Context, Manager, UUID, QREventType, QRPairingEvent
...
Cohesion: 0.29
Nodes (6): Design Areas, Overall Direction, Processed Sketches, Project: PerGo, Source Files, Theme

### Community 415 - "Community 415"
Cohesion: 0.48
Nodes (6): MockConnection, MockCreateMessageRequest, T, UUID, ResolveRoute(), TestRoutingSpike()

### Community 416 - "Community 416"
Cohesion: 0.29
Nodes (6): ADR-0003: Unify TemplateComponent type in domain, Consequences, Context, Decision, Files changed, Risk assessment
...
Cohesion: 0.48
Nodes (6): T, TestPairingTimeout(), TestQREventTypes(), TestQRPairingEvent(), TestQRPairingEvent_AllTypes(), TestStartPairing_ContextCancelled()
...
Cohesion: 0.53
Nodes (5): T, TestDeviceHandler_Construction(), TestDeviceHandler_Disconnect_EmptyJID(), TestDeviceHandler_GetQR_MissingPhone(), TestDeviceHandler_StartPairing_LimitExceeded()
...
Cohesion: 0.29
Nodes (6): Deferred Ideas, Fluxo de Re-pareamento de WhatsApp Web (whatsmeow desconectado), Limite de Conexões por Workspace (Segurança e Controle de RAM), Phase 8: Multi-Instance Connections & Dashboard UI - Discussion Log, the agent's Discretion, Transição de Banco de Dados (Tabelas Legadas vs Nova tabela 'connections')
...
Cohesion: 0.33
Nodes (5): Design Question, How to View, Sketch 001: Dashboard Layout & Navigation, Variants, What to Look For

### Community 474 - "Community 474"
Cohesion: 0.33
Nodes (5): Design Question, Features & Interactivity, How to View, Sketch 002: Onboarding vs. Operational Dashboard, What to Look For

### Community 475 - "Community 475"
Cohesion: 0.33
Nodes (5): Feature Areas, Processed Spikes, Project: PerGo, Requirements, Source Files
...
Cohesion: 0.33
Nodes (6): 4. Concurrency & Performance Strategy, Load envelope (the budget we design against), Performance knobs (sized from the envelope, not guessed), Preventing races & leaks, What we are *not* doing, Where goroutines & channels live

### Community 479 - "Community 479"
Cohesion: 0.40
Nodes (5): JID, JIDToPhone(), T, TestDeviceStatusValues(), TestJIDToPhone()
...
Cohesion: 0.67
Nodes (3): T, TestTelemetryHandler_Construction(), TestTelemetryHandler_Index_NilDeps()
...
Cohesion: 0.33
Nodes (5): Accomplishments, Next Phase Readiness, Performance, Phase 8 Wave 2: Dynamic Routing, API, Proxy & Connection Limits, Task Commits

### Community 502 - "Community 502"
Cohesion: 0.33
Nodes (5): 1. Template Layout and Pages, 2. Handlers and Routes, 3. Verification, Plan - Developer Playground with WebSockets, Tasks
...
Cohesion: 0.33
Nodes (5): Design Direction, Excluded Sketches, Included Sketches, Key Decisions, Sketch Wrap-Up Summary
...
Cohesion: 0.40
Nodes (5): Audit batch writer (classic bounded-buffer fan-in), Fan-out at the worker pool, not at the request, Patterns applied, Per-session rate limiter (staggered dispatch), Pipeline: ingest → broker → worker → channel → audit
...
Cohesion: 0.40
Nodes (4): CPaaS Dashboard UX Architecture & Layout, Design System & Theme, Dynamic Onboarding Checklist (Day 1 UX), Dynamic Rules

### Community 546 - "Community 546"
Cohesion: 0.40
Nodes (4): Business Decisions, CPaaS Monetization & Proxy Architecture, Key Implementation Principles, Technical Architecture: Proxy & Traffic Isolation
...
Cohesion: 0.40
Nodes (4): Accomplishments, Performance, Phase 8 Wave 3: Notion-Style Dashboard UI, Dynamic Onboarding & Limit Enforcement, Task Commits
...
Cohesion: 0.19
Nodes (10): TelegramWebhookHandler, Context, CredentialsRepository, NewTelegramWebhookHandler(), sha256Hash(), Context, Pool, UUID (+2 more)
...
Cohesion: 0.50
Nodes (3): Concept, Details, Seed: CPaaS Billing and SaaS Subscription Architecture

### Community 591 - "Community 591"
Cohesion: 0.50
Nodes (3): Key Findings, Processed Spikes, Spike Wrap-Up Summary

### Community 592 - "Community 592"
Cohesion: 0.50
Nodes (3): Action Items, Description, Todo: Implement Dynamic Onboarding Logic for Admin Dashboard

### Community 593 - "Community 593"
Cohesion: 0.50
Nodes (3): Action Items, Description, Todo: Implement SOCKS5/HTTP Proxy Support for WhatsMeow

### Community 594 - "Community 594"
Cohesion: 0.83
Nodes (3): DeviceCard(), DeviceStatusBadge(), Component
...
Cohesion: 1.00
Nodes (3): github.com/aws/aws-sdk-go-v2, github.com/aws/aws-sdk-go-v2/service/s3, github.com/pablojhp.pergo
...
Cohesion: 0.40
Nodes (16): createTestWorkspace(), Cookie, Echo, T, UUID, loginAndGetCookie(), setupWorkspaceRoutes(), TestAdminAPIKeyConfirmRevoke() (+8 more)

### Community 1090 - "Community 1090"
Cohesion: 0.20
Nodes (11): APIKeyHandler, Context, ConfirmModal(), Component, APIKeyGenerateForm(), APIKeyListFragment(), APIKeyRevealed(), APIKeyRevokeConfirm() (+3 more)

### Community 1094 - "Community 1094"
Cohesion: 0.09
Nodes (22): ConnectionSpike, T, Time, UUID, TestConnectionsSpike(), connectNATS(), Conn, Echo (+14 more)
...
Cohesion: 0.38
Nodes (5): ConnectionFinder, MessageHandler, Publisher, Echo, QueueDepthTracker

## Knowledge Gaps
- **5386 isolated node(s):** `_runtime-launcher.snippet.sh script`, `fs`, `path`, `{ isSemverNewer }`, `{ checkLatestVersion }` (+5381 more)
...
- **Why does `main()` connect `Community 0` to `Community 256`, `Community 131`, `Community 3`, `Community 134`, `Community 10`, `Community 12`, `Community 15`, `Community 26`, `Community 27`, `Community 159`, `Community 291`, `Community 39`, `Community 41`, `Community 43`, `Community 44`, `Community 558`, `Community 48`, `Community 52`, `Community 188`, `Community 65`, `Community 1090`, `Community 1094`, `Community 79`, `Community 89`, `Community 221`, `Community 95`, `Community 98`, `Community 99`, `Community 104`, `Community 105`, `Community 109`, `Community 119`, `Community 120`, `Community 255`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `New()` connect `Community 41` to `Community 256`, `Community 0`, `Community 130`, `Community 131`, `Community 134`, `Community 12`, `Community 15`, `Community 146`, `Community 25`, `Community 26`, `Community 27`, `Community 415`, `Community 160`, `Community 418`, `Community 558`, `Community 46`, `Community 48`, `Community 52`, `Community 447`, `Community 1089`, `Community 453`, `Community 1094`, `Community 74`, `Community 80`, `Community 89`, `Community 219`, `Community 221`, `Community 98`, `Community 99`, `Community 105`, `Community 107`, `Community 109`, `Community 370`, `Community 244`, `Community 119`, `Community 120`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Render()` connect `Community 43` to `Community 64`, `Community 65`, `Community 1090`, `Community 0`, `Community 90`, `Community 48`, `Community 26`, `Community 188`, `Community 221`, `Community 95`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Are the 149 inferred relationships involving `New()` (e.g. with `.SimulateWebhook()` and `.Send()`) actually correct?**
  _`New()` has 149 INFERRED edges - model-reasoned connections that need verification._
- **Are the 55 inferred relationships involving `main()` (e.g. with `LoginPage()` and `LoginPost()`) actually correct?**
  _`main()` has 55 INFERRED edges - model-reasoned connections that need verification._
- **Are the 34 inferred relationships involving `Render()` (e.g. with `.ConfirmRevoke()` and `.Generate()`) actually correct?**
  _`Render()` has 34 INFERRED edges - model-reasoned connections that need verification._
- **Are the 32 inferred relationships involving `NewWorkspaceRepository()` (e.g. with `TestConnectionsSpike()` and `setupAuditTestRoutes()`) actually correct?**
  _`NewWorkspaceRepository()` has 32 INFERRED edges - model-reasoned connections that need verification._