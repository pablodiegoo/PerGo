...
- Updated `internal/channel/whatsapp/waba_test.go` and `cmd/omnigo/main.go` to inject the checker correctly.
...
- Registered route in `cmd/omnigo/main.go` and exempted health, admin, and webhook paths in `AuthMiddleware`.
...
- Updated `NewManager` constructor and calls in `cmd/omnigo/main.go` to inject `recipientSessionRepo`.
...
### Created
- [006_create_recipient_sessions.sql](file:///home/pablo/Coding/OmniGo/internal/platform/postgres/migrations/006_create_recipient_sessions.sql)
- [recipient_session.go](file:///home/pablo/Coding/OmniGo/internal/repository/recipient_session.go)
- [recipient_session_test.go](file:///home/pablo/Coding/OmniGo/internal/repository/recipient_session_test.go)
- [window.go](file:///home/pablo/Coding/OmniGo/internal/session/window.go)
- [window_test.go](file:///home/pablo/Coding/OmniGo/internal/session/window_test.go)
- [telegram_webhook.go](file:///home/pablo/Coding/OmniGo/internal/api/handler/telegram_webhook.go)
- [telegram_webhook_test.go](file:///home/pablo/Coding/OmniGo/internal/api/handler/telegram_webhook_test.go)

### Modified
- [waba_template_test.go](file:///home/pablo/Coding/OmniGo/internal/api/handler/admin/waba_template_test.go)
- [waba.go](file:///home/pablo/Coding/OmniGo/internal/channel/whatsapp/waba.go)
- [waba_test.go](file:///home/pablo/Coding/OmniGo/internal/channel/whatsapp/waba_test.go)
- [auth.go](file:///home/pablo/Coding/OmniGo/internal/api/middleware/auth.go)
- [manager.go](file:///home/pablo/Coding/OmniGo/internal/session/manager.go)
