...
- Create [playground.templ](file:///home/pablo/Coding/PerGo/templates/pages/playground.templ):
...
- Modify [sidebar.templ](file:///home/pablo/Coding/PerGo/templates/layout/sidebar.templ) to add a navigation link to "/admin/playground".

### 2. Handlers and Routes
- Create [playground.go](file:///home/pablo/Coding/PerGo/internal/api/handler/admin/playground.go):
...
- Register routes in [main.go](file:///home/pablo/Coding/PerGo/cmd/pergo/main.go):
