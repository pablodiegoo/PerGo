...
### Phase 10: Inbox Refactoring & Connection Unification (completed 2026-07-06)
...
- [x] 10-01-PLAN.md — Inbox Polling Stability & Zero-JS Scroll Refactoring

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 10-02-PLAN.md — Unified Connections Dashboard & Playground Decommission

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 10-03-PLAN.md — WABA 24h Service Window Enforcement & Template Inbox Composer
