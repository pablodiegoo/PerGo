...
- **Global scope**: `/home/pablo/Coding/PerGo/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/pablo/Coding/PerGo/.opencode/notes/`)
...
2. Glob `/home/pablo/Coding/PerGo/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/pablo/Coding/PerGo/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/pablo/Coding/PerGo/.opencode/notes/` — works in any directory
