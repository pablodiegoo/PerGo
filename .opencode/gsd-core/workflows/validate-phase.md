...
```
Agent(
  prompt="Read /home/pablo/Coding/PerGo/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/pablo/Coding/PerGo/.opencode/gsd-core/templates/VALIDATION.md`
