...
Reference full template: `/home/pablo/Coding/PerGo/.opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/pablo/Coding/PerGo/.opencode/gsd-core/templates/state.md`.
